...
dag_config = Variable.get('bi_ccm_agg_mth_sample_dag_variables', deserialize_json=True, default_var={})
bi_ccm_load_sql_statement = Variable.get('bi_ccm_sample_load_sql', default_var={})
bi_ccm_timestamp_sql_statement = Variable.get('bi_ccm_sample_timestamp_sql', default_var={})
...
# DAG object.
with models.DAG(
        dag_id='bi_ccm_agg_mth_sample_dag',
