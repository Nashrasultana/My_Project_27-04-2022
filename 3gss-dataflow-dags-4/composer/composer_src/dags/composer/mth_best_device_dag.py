...
dag_config = Variable.get('mth_best_device_dag_variables', deserialize_json=True, default_var={})
mth_best_device_load_sql_statement = Variable.get('mth_best_device_load_sql', default_var={})
...
with models.DAG(
    ...
    BQtoBQ_Load_job = BigQueryExecuteQueryOperator(
        ...
        sql=mth_best_device_load_sql_statement,
    ...
    #     sql=""" update `bt-tch-3g-sunset-dp-prod.dp_consumer_rw.mth_best_device` set RECORD_TS = current_timestamp() where RECORD_TS IS NULL """,
    #     write_disposition="WRITE_APPEND",
    #     gcp_conn_id=GCP_DEFAULT_CONN,
    #     use_legacy_sql=False,
    # )    
