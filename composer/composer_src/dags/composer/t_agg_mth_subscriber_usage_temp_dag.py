...
dag_config = Variable.get('t_agg_mth_subscriber_usage_temp_dag_variables', deserialize_json=True, default_var={})
t_agg_mth_load_sql_statement = Variable.get('t_agg_mth_temp_load_sql', default_var={})
t_agg_mth_timestamp_sql_statement = Variable.get('t_agg_mth_temp_timestamp_sql', default_var={})
...
# DAG object.
with models.DAG(
        dag_id='t_agg_mth_subscriber_usage_temp_dag',
